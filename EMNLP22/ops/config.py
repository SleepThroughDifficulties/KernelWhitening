...
parser.add_argument('-data', metavar='DIR', default='/workspace/dataset',
                    help='path to dataset')

parser.add_argument('--alignment', default=False, type=bool, help='是否仅针对编码层做反向传播')
...
parser.add_argument('--class_weights', default=[1,0.4,1], type=list, action='store',
                      dest='list')
...
# parser.add_argument('--resume', default='/root/slabt/stablelearning/results/MNLI/epoch_7_checkpoint.pth.tar', type=str, metavar='PATH',
...
parser.add_argument ('--lrbl', type = float, default =2.8, help = 'learning rate of balance')
...
parser.add_argument ('--hard_dataset', type=str, default="MNLI_hard", help = '')
parser.add_argument ('--hard_output', type=str, default="MNLI_hard/hardoutlrbr6.csv", help = '')
